...
const Block = class {
  ...
  renderTitle() {
    ...
    return heading || summary ? (index.h("div", { class: CSS$1.title }, index.h(Heading.Heading, { class: CSS$1.heading, level: headingLevel || HEADING_LEVEL }, heading), summary ? index.h("div", { class: CSS$1.summary }, summary) : null)) : null;
  }
  render() {
    ...
    return (index.h(index.Host, null, index.h("article", { "aria-busy": loading.toString(), class: {
        [CSS$1.article]: true
