...
const Dropdown = class {
  constructor(hostRef) {
    ...
    */
    ...
    this.updateItems = () => {
      ...
      this.triggers = dom.getSlotted(this.el, "dropdown-trigger", { all: true });
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "calcite-dropdown-trigger-container", onClick: this.openCalciteDropdown, onKeyDown: this.keyDownHandler, ref: this.setReferenceEl }, index.h("slot", { "aria-expanded": active.toString(), "aria-haspopup": "true", name: SLOTS.dropdownTrigger })), index.h("div", { "aria-hidden": (!active).toString(), class: "calcite-dropdown-wrapper", ref: this.setMenuEl }, index.h("div", { class: {
      ...
      }, onTransitionEnd: this.transitionEnd, ref: this.setScrollerEl }, index.h("div", { hidden: !this.active }, index.h("slot", null))))));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
