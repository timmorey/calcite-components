...
const resources = require('./resources-188e5b46.js');
...
const Panel = class {
  ...
  renderContent() {
    ...
    return hasFab ? (index.h("div", { class: { [CSS.contentWrapper]: true, [CSS.contentHeight]: true }, key: contentWrapperKey, onScroll: this.panelScrollHandler, ref: (el) => (this.panelScrollEl = el), tabIndex: 0 }, index.h("section", { class: CSS.contentContainer }, defaultSlotNode), this.renderFab())) : (index.h("section", { class: { [CSS.contentWrapper]: true, [CSS.contentContainer]: true }, key: contentWrapperKey, onScroll: this.panelScrollHandler, ref: (el) => (this.panelScrollEl = el), tabIndex: 0 }, defaultSlotNode));
  }
  renderFab() {
