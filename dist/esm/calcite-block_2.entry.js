...
const Block = class {
  ...
  renderTitle() {
    ...
    return heading || summary ? (h("div", { class: CSS$1.title }, h(Heading, { class: CSS$1.heading, level: headingLevel || HEADING_LEVEL }, heading), summary ? h("div", { class: CSS$1.summary }, summary) : null)) : null;
  }
  render() {
