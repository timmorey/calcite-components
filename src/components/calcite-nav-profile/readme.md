...
| `srcTitle`         | `src-title`         |                                                         | `"light" \| "name"`                      | `"name"`    |
| `theme`            | `theme`             | Select theme (light or dark)                            | `"dark" \| "light"`                      | `"light"`   |
| `userName`         | `user-name`         |                                                         | `any`                                    | `undefined` |
| `userOrganization` | `user-organization` |                                                         | `any`                                    | `undefined` |

## Events

| Event                           | Description | Type               |
| ------------------------------- | ----------- | ------------------ |
| `calciteShellDrawerToggleEvent` |             | `CustomEvent<any>` |
