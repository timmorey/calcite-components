...
@Component({
  tag: "calcite-drawer",
  styleUrl: "calcite-drawer.scss",
  shadow: true
})
export class CalciteDrawer {
  //--------------------------------------------------------------------------
  //
  //  Element
  //
  //--------------------------------------------------------------------------
  @Element() el: HTMLCalciteDrawerElement;
  ...
  render(): VNode {
    ...
    return (
      <Host aria-drawer="true" dir={dir} is-active={this.isActive} role="dialog">
