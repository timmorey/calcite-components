...
- [calcite-nav-app-switcher-group](../calcite-nav-app-switcher-group)
- [calcite-nav-app-switcher-item](../calcite-nav-app-switcher-item)
...
graph TD;
  ...
  style calcite-nav-app-switcher fill:#f9f,stroke:#333,stroke-width:4px
```
